...
ALTER TABLE  `cmseasy_user` ADD  `regtime` int( 10 ) UNSIGNED NULL DEFAULT  '0';
ALTER TABLE  `cmseasy_user` ADD  `sex` varchar( 10 ) NULL DEFAULT  NULL;
ALTER TABLE  `cmseasy_user` ADD  `isblock` tinyint( 1 ) UNSIGNED NULL DEFAULT  '0';
ALTER TABLE  `cmseasy_user` ADD  `isdelete` tinyint( 1 ) UNSIGNED NULL DEFAULT  '0';
