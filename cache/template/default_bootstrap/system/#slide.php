...
<style type="text/css">
.carousel-caption h3,.carousel-caption p {color:#<?php echo get(slide_text_color);?>;}
.carousel-indicators li {border: 1px solid #<?php echo get(slide_btn_color);?>;}
.carousel-indicators .active {border: 1px solid #<?php echo get(slide_btn_hover_color);?>;background-color: #<?php echo get(slide_btn_hover_color);?>;}
.btn-primary {color: #<?php echo get(slide_btn_text_color);?>;
    background-color: #<?php echo get(slide_btn_hover_color);?>;
    border-color: #<?php echo get(slide_btn_hover_color);?>;}
</style>
