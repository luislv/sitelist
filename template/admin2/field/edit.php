...
<tbody>
 <tr>
	...
	{if front::$act=='edit'}
                    <b>{$field.name}</b>
                    <input type="hidden"  name="name" id="name" value="{$field.name}" onkeyup="value=value.replace(/[\W]/g,'') " onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^\d]/g,''))" />
	{else}
                    <input size="20" name="name" id="name" value="my_" onblur="form_preview()" onkeyup="value=value.replace(/[\W]/g,'') " onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^\d]/g,''))" />
